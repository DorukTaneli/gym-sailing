...
class JtrEnvV2(gym.Env):

  metadata = {'render.modes': ['human', 'console']}

  def __init__(self):
    super(JtrEnvV2, self).__init__()
    self.viewer = None
    ...
    self.state_estimator = state_estimator.StateEstimator(observation_features=observation_features, parallel=True)
